<template>
        ...
        <div class="post">
            ...
            <div class="body_post">
                <div class="post_content">
                    ...
                    <br />
                    <p>
                        Welcome back. Click the "My Visits" button below to review and manage your current visits.
                    </p>
                    <br />
                    <p>
                        Click the "Schedule a Visit" button below to scheudle a new visit.
                    </p>
                    <br />
                    <div class="container_infos">
                        <div class="container_tags">
                            <div class="tags">
                                <ul>
                                    <li @click="$emit('show-visit-scheduler')">Schedule a Visit</li>
                                </ul>
                            </div>
                        </div>
                        <div class="container_tags">
                            <div class="tags">
                                <ul>
                                    <li @click="$emit('show-my-visits')">My Visits</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    export default {
        ...
        mounted() {
            this.firstName = this.userInfo.displayName.split(' ')[0];
        }
    }
    </script>
