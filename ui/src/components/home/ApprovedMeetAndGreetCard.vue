        ...
        <div class="post">
            ...
            <div class="body_post">
                <div class="post_content">
                    ...
                    <br />
                    <p>
                        You will be meeting with <b>{{appointment.assignedEmployeeName}}</b> on <b>{{appointment.appointment}}</b>
                    </p>
                    <br />
                    <p>
                        If you need to reschedule, please contact <b>{{appointment.assignedEmployee}}</b>
                    </p>
                    <br />
                </div>
            </div>
